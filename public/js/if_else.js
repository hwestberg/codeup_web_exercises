...
if (color == "red") {
	console.log("Red is the color of a cherry.");
} 
	...
	console.log("Green is the color of a shamrock.");
}
...
(color == favorite) ? console.log(favorite + "is my favorite color") : console.log(color + is not my favorite color."); 
